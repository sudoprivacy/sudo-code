...
mod tests {
    use super::{
        ...
        filter_tool_specs, format_history_timestamp, format_status_report,
        format_unknown_slash_command, merge_prompt_with_stdin, normalize_permission_mode,
