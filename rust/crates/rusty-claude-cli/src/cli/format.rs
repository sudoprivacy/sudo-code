...
pub(crate) fn format_unknown_slash_command_message(name: &str) -> String {
    ...
    if let Some(note) = crate::omc_compatibility_note_for_unknown_slash_command(name) {
        message.push(' ');
...
mod tests {
    use super::*;
    use crate::{GitWorkspaceSummary, InternalPromptProgressEvent, InternalPromptProgressState};
    use api::ApiError;
    use serde_json::json;
    use std::time::Duration;
